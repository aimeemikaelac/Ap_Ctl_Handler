...
set ::env(LD_LIBRARY_PATH) /home/michael/Xilinx/Vivado_HLS/2014.1/lnx64/tools/fpo_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/michael/Xilinx/Vivado_HLS/2014.1/lnx64/tools/opencv:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/michael/Xilinx/Vivado_HLS/2014.1/lnx64/tools/fft_v9_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/michael/Xilinx/Vivado_HLS/2014.1/lnx64/tools/fir_v7_0:$::env(LD_LIBRARY_PATH)
...
if {[file isfile ap_ctl_handler.autotvin.dat]} {
    file delete -force ap_ctl_handler.autotvin.dat
}
if {[file isfile ap_ctl_handler.autotvout.dat]} {
    file delete -force ap_ctl_handler.autotvout.dat
}
...
file delete -force [file join "../tv" ap_ctl_handler.hdltvin.dat]
file delete -force [file join "../tv" ap_ctl_handler.hdltvout.dat]
file delete -force  "err.log"
